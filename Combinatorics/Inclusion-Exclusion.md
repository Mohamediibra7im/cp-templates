...
![Venn diagram](https://d3moma7wl9.ufs.sh/f/xRZhVxWEJbFMIJpJLCPEeGZXUB1jACvcYluDz8w2o0H3VtnN)
...
Forget the restriction on $x_i$ for a moment and just count the number of nonnegative solutions to this equation. This is easily done using [Stars and Bars](Stars-and-bars-technique.md):
...
* [SPOJ - Another Game With Numbers [difficulty: low]](http://www.spoj.com/problems/NGM2/)
* [SPOJ - Sky Code [difficulty: medium]](http://www.spoj.com/problems/MSKYCODE/)
* [SPOJ - Square-free integers [difficulty: medium]](http://www.spoj.com/problems/SQFREE/)
...
* [UVA  - The Lottery [difficulty: low]](http://uva.onlinejudge.org/index.php?option=onlinejudge&page=show_problem&problem=1266)
* [UVA - Cheerleaders [difficulty: low]](http://uva.onlinejudge.org/index.php?option=com_onlinejudge&Itemid=8&page=show_problem&problem=2906)
